 ...
 */
final class Version20260313142801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alergeno (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE categoria (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, descripcion LONGTEXT DEFAULT NULL, activa TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE ingredientes (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, descripcion LONGTEXT DEFAULT NULL, activo TINYINT NOT NULL, creado_en DATETIME NOT NULL, actualizado_en DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE platos_ingredientes (ingrediente_id INT NOT NULL, plato_id INT NOT NULL, INDEX IDX_92C9C8D7769E458D (ingrediente_id), INDEX IDX_92C9C8D7B0DB09EF (plato_id), PRIMARY KEY (ingrediente_id, plato_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE ingredientes_alergenos (ingrediente_id INT NOT NULL, alergeno_id INT NOT NULL, INDEX IDX_1FC7BA14769E458D (ingrediente_id), INDEX IDX_1FC7BA143E89035 (alergeno_id), PRIMARY KEY (ingrediente_id, alergeno_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE platos_ingredientes ADD CONSTRAINT FK_92C9C8D7769E458D FOREIGN KEY (ingrediente_id) REFERENCES ingredientes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE platos_ingredientes ADD CONSTRAINT FK_92C9C8D7B0DB09EF FOREIGN KEY (plato_id) REFERENCES platos (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ingredientes_alergenos ADD CONSTRAINT FK_1FC7BA14769E458D FOREIGN KEY (ingrediente_id) REFERENCES ingredientes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ingredientes_alergenos ADD CONSTRAINT FK_1FC7BA143E89035 FOREIGN KEY (alergeno_id) REFERENCES alergeno (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE platos ADD CONSTRAINT FK_1D29312A3397707A FOREIGN KEY (categoria_id) REFERENCES categoria (id)');
        ...
        $this->addSql('ALTER TABLE platos_alergenos ADD CONSTRAINT FK_3762847B3E89035 FOREIGN KEY (alergeno_id) REFERENCES alergeno (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE platos_ingredientes DROP FOREIGN KEY FK_92C9C8D7769E458D');
        $this->addSql('ALTER TABLE platos_ingredientes DROP FOREIGN KEY FK_92C9C8D7B0DB09EF');
        $this->addSql('ALTER TABLE ingredientes_alergenos DROP FOREIGN KEY FK_1FC7BA14769E458D');
        $this->addSql('ALTER TABLE ingredientes_alergenos DROP FOREIGN KEY FK_1FC7BA143E89035');
        ...
        $this->addSql('DROP TABLE ingredientes');
        $this->addSql('DROP TABLE platos_ingredientes');
        $this->addSql('DROP TABLE ingredientes_alergenos');
